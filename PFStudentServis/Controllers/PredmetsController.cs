...
namespace PFStudentServis.Controllers
{
    public class PredmetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OznakaPredmeta,NazivPredmeta,BrESPBbodova")] Predmet predmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OznakaPredmeta,NazivPredmeta,BrESPBbodova")] Predmet predmet)
        {
            if (ModelState.IsValid)
            {
